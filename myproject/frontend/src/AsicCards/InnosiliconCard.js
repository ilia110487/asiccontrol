...
const InnosiliconCard = ({ device, onEditDevice, onDeleteDevice }) => {
    ...
    if (!minerData) return <div className="innosilicon-card">Загрузка...</div>;
    ...
    return (
        <div className="innosilicon-card">
            <div className="card-header">
                <div>
                    <span className="device-type">{minerData.type}</span>
                    <span className="device-ip">{device.ip}</span>
                </div>
                <div className="hashrate-section">
                    <span className="hashrate">{minerData.hashrate.toFixed(2)} TH/s</span>
                    <DeviceMenu
...
export default InnosiliconCard;
